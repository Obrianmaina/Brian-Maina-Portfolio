    ...
    <div className="min-h-screen bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-200">
        ...
        <div className="space-y-8 text-gray-600 leading-relaxed text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">1. Information Collection</h2>
            <p>When you interact with this website, certain personal information may be collected. This includes:</p>
            <ul className="list-disc pl-5 mt-2 space-y-1.5">
              <li><strong>Contact details:</strong> Your email address and preferred name or nickname when you request a quote, subscribe to the blog, or join the newsletter.</li>
              <li><strong>Project details:</strong> Information you willingly provide about your design or development needs through the quote request form.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-gray-900 mb-3">2. How Your Information is Used</h2>
            ...
            <p className="mt-3 font-medium text-gray-700">Your data will never be sold to or shared with third parties for marketing purposes.</p>
          </section>
