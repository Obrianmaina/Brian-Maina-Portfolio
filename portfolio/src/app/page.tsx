...
const experienceData: TimelineSection[] = [
  ...
  const skills = ["UI/UX Design", "Graphic Design", "Motion Graphics", "Email Marketing", "Copy Writing", "Adobe Photoshop", "Adobe Experience Manager", "Adobe Illustrator", "Adobe After Effects", "Adobe Premier Pro", "Figma", "Canva", "Adobe InDesign", "Adobe Audition", "Microsoft Powerpoint", "Affinity", "Data Visualization", "Mailchimp", "Inkscape", "Mural", "Figjam", "Miro", "Google Slides", "HTML", "CSS", "Davinci Resolve", "Github", "Corel Draw", "AI"];
