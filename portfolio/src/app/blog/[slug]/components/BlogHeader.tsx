    ...
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10 gap-4">
      ...
      <div className="flex items-center gap-3 w-full sm:w-auto">
        <button
          ...
          className="flex-1 sm:flex-none flex justify-center items-center gap-2 bg-teal-50 dark:bg-teal-900/30 hover:bg-teal-100 dark:hover:bg-teal-900/50 text-teal-700 dark:text-teal-300 px-5 py-2.5 rounded-full transition-all border border-teal-100 dark:border-teal-800 shadow-sm font-medium"
        >
          <Mail size={18} />
          Subscribe
        </button>
