                ...
                <Card key={blog._id} className="overflow-hidden flex flex-col h-full hover:shadow-xl transition-shadow relative">
                  ...
                  <CardContent className="px-6 pb-6 pt-2 flex flex-col flex-grow">
                    ...
                    <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                      <button onClick={() => openEditorForEdit(blog)} className="text-blue-600 hover:text-blue-800 flex items-center text-sm font-medium transition-colors">
                      ...
                      <button onClick={(e) => blog._id && confirmDelete(blog._id, e)} className="text-red-600 hover:text-red-800 flex items-center text-sm font-medium transition-colors">
