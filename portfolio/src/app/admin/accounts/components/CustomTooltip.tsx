...
export default function CustomTooltip({ active, payload, label }: CustomTooltipProps) {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 p-4 border border-gray-100 dark:border-gray-800 shadow-xl dark:shadow-none rounded-full transition-colors duration-300">
