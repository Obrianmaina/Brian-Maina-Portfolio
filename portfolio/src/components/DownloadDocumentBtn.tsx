...
export default function DownloadDocumentBtn({ 
  ...
  if (!isMounted) {
    return (
      <button disabled className={`flex items-center justify-center text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-900 cursor-not-allowed shadow-sm transition-colors duration-300 ${iconOnly ? 'p-2 rounded-lg' : 'px-4 py-2 rounded-full text-sm font-medium border border-gray-200 dark:border-gray-800'}`}>
